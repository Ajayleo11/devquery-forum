      ...
      <CardContent>
        <form action={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <Textarea id="bio" name="bio" placeholder="Tell us about yourself..." maxLength={500} rows={4} className="resize-none" />
            <p className="text-sm text-muted-foreground">Maximum 500 characters</p>
          </div>

          <div className="space-y-2">
            <Label htmlFor="location">Location</Label>
            <Input id="location" name="location" placeholder="San Francisco, CA" maxLength={100} />
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Include full URL (https://...)</p>
          </div>

          <div className="space-y-2">
            <Label htmlFor="githubHandle">GitHub Username</Label>
            <Input id="githubHandle" name="githubHandle" placeholder="yourusername" maxLength={39} />
            <p className="text-sm text-muted-foreground">Just your GitHub username, not the full URL</p>
          </div>
