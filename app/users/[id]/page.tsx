...
export default function UserProfilePage() {
  ...
  if (isLoading) return <div className="max-w-5xl mx-auto">Loading profile...</div>;
  if (error || !data?.data) return <div className="max-w-5xl mx-auto">Error loading profile</div>;
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-card p-6 border border-border rounded">
          <h2 className="font-heading text-xl font-bold mb-4 text-card-foreground">Questions</h2>
        ...
        <div className="bg-card p-6 border border-border rounded">
          <h2 className="font-heading text-xl font-bold mb-4 text-card-foreground">Answers</h2>
          <div className="text-3xl font-bold text-card-foreground mb-2">
            {profile?.answersCount || 0}
          </div>
          ...
          <div className="space-y-4">
            {answers.map((answer) => (
              <div key={answer.id} className="pb-4 border-b border-border last:border-b-0">
                ...
                <div className="text-card-foreground mb-2 line-clamp-3">{answer.content}</div>
                <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
