    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center py-16 md:py-20">
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          powered by GPT-4o, plus insights from the community
        </p>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-16">
        <div className="bg-card p-6 rounded shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-xl font-semibold text-card-foreground">Instant AI Answers</h3>
          </div>
          <p className="text-sm text-muted-foreground">
            Every question gets an AI-generated answer within seconds using GPT-4o
          </p>
        </div>
        ...
        <div className="bg-card p-6 rounded shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-xl font-semibold text-card-foreground">Auto-Tagging</h3>
          </div>
          <p className="text-sm text-muted-foreground">
        ...
        <div className="bg-card p-6 rounded shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-xl font-semibold text-card-foreground">Community Answers</h3>
          </div>
          <p className="text-sm text-muted-foreground">
